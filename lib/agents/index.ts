...
export const AGENT_ROSTER: AgentSpec[] = [
  ...
  { name: "Risk Monitoring", phase: 1, job: "Spend, cash, e-invoice & concentration risk", autonomous: "Flag + score risks", neverWithoutHuman: "Take corrective action" },
  { name: "News Relevance", phase: 1, job: "Pull + rank relevant news", autonomous: "Fetch, filter, summarise with sources", neverWithoutHuman: "Present unverified claims as fact" },
