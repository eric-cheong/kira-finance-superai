                ...
                <div className="mt-3 space-y-2">
                  ...
                  <div className="space-y-1.5">
                    {result.evidence.slice(0, 3).map((item) => (
                      <div key={`${key}-${item.label}`} className="flex min-w-0 items-start justify-between gap-2 text-[12px] leading-relaxed">
                        <span className="shrink-0 text-faint">{item.label}</span>
                        {item.url ? (
